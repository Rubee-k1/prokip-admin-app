                ...
                <div className="space-y-6 animate-fade-in">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div className="h-64">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <BarChart data={activeVsInactiveData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                            ...
                                            <Legend iconType="circle" wrapperStyle={{ fontSize: '12px', fontWeight: 'bold' }} />
                                            <Bar dataKey="active" name="Active Customers" stackId="a" fill="#3B82F6" radius={[0, 0, 4, 4]} />
                                            <Bar dataKey="inactive" name="Inactive Customers" stackId="a" fill="#CBD5E1" radius={[4, 4, 0, 0]} />
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                                <h3 className="font-bold text-slate-800 mb-6">Top Customer Locations</h3>
                                <div className="h-64">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <BarChart layout="vertical" data={locationData} margin={{ top: 0, right: 30, left: 10, bottom: 0 }}>
                                            ...
                                            <Tooltip contentStyle={{ borderRadius: '8px', border: 'none', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }} cursor={{fill: '#f8fafc'}} />
                                            <Bar dataKey="users" name="Active Endpoint Customers" fill="#8B5CF6" radius={[0, 4, 4, 0]}>
