...
const CXHeadDashboardView: React.FC<CXHeadDashboardViewProps> = ({ setView, userRole }) => {
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-6 overflow-y-auto custom-scrollbar h-full">
            <div className="mb-8">
                ...
                <p className="text-sm text-slate-500">{deptName} Department Overview & Personal Performance</p>
            </div>
