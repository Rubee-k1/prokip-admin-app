                    ...
                    {view === 'detail' && selectedComplaint && (
                        <div className="space-y-6">
                            ...
                            <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6 border-y border-slate-50 py-4">
                                    <div>
                                        <p className="text-[10px] font-bold text-slate-400 uppercase">Ticket Type</p>
                                        <p className="text-xs font-bold text-[#02275A] bg-blue-50/50 px-2 py-1 rounded inline-block mt-0.5 border border-blue-100">{selectedComplaint.ticketType || 'Customer'}</p>
                                    </div>
                                    <div>
                                        <p className="text-[10px] font-bold text-slate-400 uppercase">Ticket By</p>
                                        <p className="text-sm font-semibold text-slate-700 mt-0.5">{selectedComplaint.targetName || business.name}</p>
                                    </div>
                                    <div>
                                        <p className="text-[10px] font-bold text-slate-400 uppercase">Category</p>
                                        <p className="text-sm font-semibold text-slate-700 mt-0.5">{selectedComplaint.category}</p>
                                    </div>
                                    <div>
                                        <p className="text-[10px] font-bold text-slate-400 uppercase">Priority</p>
                                        <p className={`text-sm ${getPriorityColor(selectedComplaint.priority)} mt-0.5`}>{selectedComplaint.priority}</p>
                                    </div>
                                </div>
