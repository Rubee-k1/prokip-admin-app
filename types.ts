...
export type UserRole = 'agent' | 'manager' | 'admin' | 'team-lead' | 'cx-head' | 'call-agent' | 'sales-manager' | 'support-staff' | 'finance' | 'marketing-manager' | 'content-lead' | 'customer-success' | 'employee';
